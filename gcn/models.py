...
class GCN(Model):
    def __init__(self, placeholders, input_dim, **kwargs):
        ...
        self.optimizer = tf.train.AdamOptimizer(learning_rate=FLAGS.learning_rate) #tf.train.AdamOptimizer
    ...
    def _loss(self):
        ...
        # RMSE error
        self.loss += loss(self.outputs, self.placeholders['labels'])
    ...
    def _build(self):
        ...
        self.layers.append(GraphConvolution(input_dim=128,
                                            output_dim=64,
                                            placeholders=self.placeholders,
                                            act=tf.nn.relu,
                                            dropout=True,
        ...
        # self.layers.append(Dense(input_dim=128,
        #                          output_dim=self.output_dim,
        #                          placeholders=self.placeholders,
        #                          act=lambda x: x,
        #                          dropout=True,
